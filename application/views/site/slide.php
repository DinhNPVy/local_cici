            ...
            <div class="row top-row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="single-item js-banner">
                        <div class="slide-img">
                            <img src="<?php echo public_url() ?>site/image/image-slider1.jpg" alt="images" class="img-reponsive">
                        ...
                        <div class="slide-img">
                            <img src="<?php echo public_url() ?>site/image/image-slider2.jpg" alt="images" class="img-reponsive">
